...
//     if (adminId) {
//       fetchHostels(adminId); // Fetch hostels based on adminId
//     } else {
//       // Handle the case where session is not available (maybe redirect to login or show an error)
//       toast({
//         title: "Error",
...
//   const fetchHostels = async (adminId) => {
//     try {
...
//         headers: {
//           'Content-Type': 'application/json',
//           'X-Hostel-Id': hostelId,  // Send hostelId as a header
//         },
...
//           <CardContent className="bg-white p-8 rounded-lg w-full max-w-2xl">
//             <HostelForm
